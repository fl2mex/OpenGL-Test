...
int main(void)
{
    ...
    // Scope bug fix for persistent terminal
    {
        ...
        while (!glfwWindowShouldClose(window))
        {
            ...
            // ImGui Test
            {
                ImGui::SliderFloat("Translation X", &translation.x, 0.0f, 1920.0f);
                ImGui::SliderFloat("Translation Y", &translation.y, 0.0f, 1080.0f);
                ImGui::SliderFloat("Translation Z", &translation.z, -1.1f, 1.1f);
